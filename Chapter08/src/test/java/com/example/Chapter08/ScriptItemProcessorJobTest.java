...
@SpringBootTest(args = { "customerFile=classpath:/input/customer.csv", 
		                 "script=classpath:/upperCase.js"}, 
                properties = { "spring.batch.job.name=job",
                               "main.scenario=scriptItemProcessorJob",
				               "spring.batch.job.enabled=false" },
                classes = ScriptItemProcessorJob.class)
class ScriptItemProcessorJobTest {
	...
	protected JobParameters composeParameters() {
		...
		jpBuilder.addString("script", "classpath:/upperCase.js");
