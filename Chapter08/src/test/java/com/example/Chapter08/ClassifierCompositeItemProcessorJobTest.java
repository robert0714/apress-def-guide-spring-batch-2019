...
@SpringBootTest(args = { "customerFile=classpath:/input/customer.csv",
		                 "script=classpath:/lowerCase.js"}, 
                properties = { "spring.batch.job.name=job",
                               "main.scenario=classifierCompositeItemProcessorJob",
				               "spring.batch.job.enabled=false" },
                classes = ClassifierCompositeItemProcessorJob.class)
class ClassifierCompositeItemProcessorJobTest {
	...
	protected JobParameters composeParameters() {
		...
		jpBuilder.addString("script", "classpath:/lowerCase.js");
