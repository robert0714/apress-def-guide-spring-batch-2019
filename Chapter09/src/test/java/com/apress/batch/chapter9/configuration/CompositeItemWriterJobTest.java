...
//               		       "logging.level.org.hibernate.engine.transaction.jta=DEBUG",
                              "main.scenario=compositeWriterJob",
                              "spring.job.names=compositeWriterJob",
				              "spring.batch.job.enabled=false" },
               classes =  Chapter9Application.class  )
@Import(value= {
//		TestMysqlApplication.class,
		CompositeItemWriterJob.class , MockConfiguration.class })
class CompositeItemWriterJobTest {
...
//					executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD) })
	@Test 
	public void givenJob_whenJobExecuted_thenSuccess(@Autowired @Qualifier("compositeWriterJob") Job job) throws Exception {		
        ...
        assertEquals("compositeWriterJob", jobInstance.getJobName());
