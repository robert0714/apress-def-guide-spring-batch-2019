...
@SpringBootTest(args = { "customerFile=classpath:/data/customer.csv",
               ...
               properties = { "spring.batch.job.name=jdbcFormatJob",
               		       "spring.autoconfigure.exclude=org.springframework.boot.autoconfigure.mongo.MongoAutoConfiguration,org.springframework.boot.autoconfigure.data.mongo.MongoDataAutoConfiguration",
//               		       "logging.level.org.springframework=DEBUG",
//               		       "logging.level.org.hibernate.engine.transaction.jta=DEBUG",
                              "main.scenario=jdbcFormatJob",
                              "spring.job.names=jdbcFormatJob",
...
//					executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD) })
	@Test 
	public void givenJob_whenJobExecuted_thenSuccess(@Autowired @Qualifier("jdbcFormatJob") Job job) throws Exception {		
        ...
        assertEquals("jdbcFormatJob", jobInstance.getJobName());
