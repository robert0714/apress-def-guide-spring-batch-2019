...
@SpringBootTest(args = { "customerFile=classpath:/data/customer.csv",
               ...
               properties = { "spring.batch.job.name=hibernateFormatJob",
               		       "spring.autoconfigure.exclude=org.springframework.boot.autoconfigure.mongo.MongoAutoConfiguration,org.springframework.boot.autoconfigure.data.mongo.MongoDataAutoConfiguration",
//               		       "logging.level.org.springframework=DEBUG",
//               		       "logging.level.org.hibernate.engine.transaction.jta=DEBUG",
                              "main.scenario=hibernateFormatJob",
                              "spring.job.names=hibernateFormatJob",
				              "spring.batch.job.enabled=false" },
               classes =  Chapter9Application.class  )
@Import(value= {
//		TestMysqlApplication.class,
		HibernateImportJob.class , MockConfiguration.class })
class HibernateImportJobTest {
...
//					executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD) })
	@Test 
	public void givenJob_whenJobExecuted_thenSuccess(@Autowired @Qualifier("hibernateFormatJob") Job job) throws Exception {		
        ...
        assertEquals("hibernateFormatJob", jobInstance.getJobName());
