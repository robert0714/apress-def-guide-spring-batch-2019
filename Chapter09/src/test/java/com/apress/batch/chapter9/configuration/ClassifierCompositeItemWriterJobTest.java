...
/***
 * mvn test -Dtest="EmailSendingJobTest"
 * **/
@SpringBatchTest
@SpringBootTest(args = { "customerFile=classpath:/data/customerWithEmail.csv",
		                 "outputFile=file:/tmp/customer.xml"
               }, 
               properties = { "spring.batch.job.name=classifierCompositeItemWriterJob",
               		       "spring.autoconfigure.exclude=org.springframework.boot.autoconfigure.mongo.MongoAutoConfiguration,org.springframework.boot.autoconfigure.data.mongo.MongoDataAutoConfiguration",
//               		       "logging.level.org.springframework=DEBUG",
//               		       "logging.level.org.hibernate.engine.transaction.jta=DEBUG",
                              "main.scenario=classifierCompositeWriterJob",
                              "spring.job.names=classifierCompositeWriterJob",
				              "spring.batch.job.enabled=false" },
               classes =  Chapter9Application.class  )
@Import(value= {
//		TestMysqlApplication.class,
		ClassifierCompositeItemWriterJob.class , MockConfiguration.class })
class ClassifierCompositeItemWriterJobTest {
...
//					executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD) })
	@Test 
	public void givenJob_whenJobExecuted_thenSuccess(@Autowired @Qualifier("classifierCompositeWriterJob") Job job) throws Exception {		
        ...
        assertEquals("classifierCompositeWriterJob", jobInstance.getJobName());
