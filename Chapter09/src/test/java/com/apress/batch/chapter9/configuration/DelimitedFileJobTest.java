...
//               		       "logging.level.org.hibernate.engine.transaction.jta=DEBUG",
                              "main.scenario=delimitedJob",
                              "spring.job.names=delimitedJob",
				              "spring.batch.job.enabled=false" },
               classes =  Chapter9Application.class  )
@Import(value= {
//		TestMysqlApplication.class,
		DelimitedFileJob.class , MockConfiguration.class })
...
//					executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD) })
	@Test 
	public void givenJob_whenJobExecuted_thenSuccess(@Autowired @Qualifier("delimitedJob") Job job) throws Exception {		
        ...
        assertEquals("delimitedJob", jobInstance.getJobName());
