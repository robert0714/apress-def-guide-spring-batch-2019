...
@Slf4j
@SpringBatchTest
@SpringBootTest(args = { "customerFile=classpath:/input/customer.json" }, 
                properties = { "spring.batch.job.name=job",
                		       "main.scenario=jsonJob",
				               "spring.batch.job.enabled=false" },
                classes =  JsonJob.class)
@Import(value= {
...
//		JobExecution jobExecution = jobLauncherTestUtils.launchJob();  
	...
	protected JobParameters composeParameters() {
		...
		jpBuilder.addString("customerFile", "classpath:/input/customer.json");
