...
@Slf4j
@SpringBatchTest
@SpringBootTest(args = { "customerFile=classpath:/input/customerFixedWidth.txt" }, 
                properties = { "spring.batch.job.name=job",
                		       "main.scenario=fixedWidthJob",
				               "spring.batch.job.enabled=false" },
                classes = FixedWidthJob.class)
@Import(value= {
		TestMongoDBApplication.class, })
class FixedWidthJobTest {
...
//		JobExecution jobExecution = jobLauncherTestUtils.launchJob();  
	...
	protected JobParameters composeParameters() {
		...
		jpBuilder.addString("customerFile", "classpath:/input/customerFixedWidth.txt");
