...
@Slf4j
@SpringBatchTest
@SpringBootTest(args = { "customerFile=classpath:/input/customer.xml" }, 
                properties = { "spring.batch.job.name=job",
                		       "main.scenario=xmlJob",
				               "spring.batch.job.enabled=false" },
                classes = XmlJob.class)
@Import(value= {
...
//		JobExecution jobExecution = jobLauncherTestUtils.launchJob();  
	...
	protected JobParameters composeParameters() {
		...
		jpBuilder.addString("customerFile", "classpath:/input/customer.xml");
